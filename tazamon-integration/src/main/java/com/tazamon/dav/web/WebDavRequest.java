...
public interface WebDavRequest {
     ...
     *
     * @param davRequest {@link DavRequest} entity representing the requirement for performing Web Dav Request.
     * @return {@link DavResponse} instance used to get the desired data from the response.
     */
    Optional<DavResponse> submitRequest(DavRequest davRequest);
}
