...
public class CalendarDavTazamonAdapterTest {
    ...
    private DavTazamonAdapter<List<Calendar>> underTestCalendarDavTazamonAdapter;
    ...
    @Test
    public void givenMultiStatusResponseIsEmptyWhenAdaptingCalendarThenEmptyCalendarListIsReturned() {
        assertThat(
