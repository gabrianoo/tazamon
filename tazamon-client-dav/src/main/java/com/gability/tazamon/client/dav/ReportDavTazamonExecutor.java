...
import static com.gability.tazamon.client.dav.HttpMethod.REPORT;
...
public class ReportDavTazamonExecutor implements DavTazamonExecutor {
    ...
    private String executeReportRequest(DavTazamonRequest davTazamonRequest) {
